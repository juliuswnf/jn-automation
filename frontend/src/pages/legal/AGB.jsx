    ...
    <div className="min-h-screen bg-black text-white py-16">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          {/* §8 */}
          <section className="mb-10">
            <h2 className="text-xl font-bold text-white mb-4">§8 Verfügbarkeit</h2>
            <div className="text-gray-300 space-y-3">
              <p>
          ...
          {/* §9 */}
          <section className="mb-10">
            <h2 className="text-xl font-bold text-white mb-4">§9 Haftung</h2>
            <div className="text-gray-300 space-y-3">
              <p>
          ...
          {/* §11 */}
          <section className="mb-10">
            <h2 className="text-xl font-bold text-white mb-4">§11 Schlussbestimmungen</h2>
            <div className="text-gray-300 space-y-3">
              <p>
